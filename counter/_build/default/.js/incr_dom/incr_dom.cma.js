    ...
    function request_animation_frame(callback)
     {var
      ...
      var
       ...
       animation_frame_id=Js_of_ocaml_Dom_html[8].requestAnimationFrame(t12),
       t14=caml_js_wrap_callback(function(param){return callback$0(0)}),
       set_timeout_id=Js_of_ocaml_Dom_html[8].setTimeout(t14,1000.),
       _bL_=request_ids[1];
         ...
         {var prev_html=[0,html],prev_elt=[0,html_dom];
          function refocus_root_element(param)
           {var element=prev_elt[1];
            function _bC_(t29)
             {var t28={"preventScroll":Js_of_ocaml_Js[7]};
              return t29.focus(t28)}
            var
